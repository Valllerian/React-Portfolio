    ...
    <div>
            ...
            <section className="resume-section" id="experience">
                <div className="resume-section-content">
                    ...
                    <Project key={project.id} title={project.title} tech={project.tech} description={project.description} deployedApp={project.deployedApp} gitHub={project.gitHub} img={project.img}/>
                     ))}
                </div>
